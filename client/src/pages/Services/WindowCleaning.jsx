...
// Import images
import office1 from '../../assets/images/window1.jpeg';
import office2 from '../../assets/images/window2.jpg';
import office3 from '../../assets/images/window3.jpeg';
import office4 from '../../assets/images/window4.jpg';
import office5 from '../../assets/images/window5.jpeg';
import office7 from '../../assets/images/window1.jpeg';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(import.meta.env.VITE_CONTACT_URL || 'http://localhost:4000/api/contact', {
                ...
                message: `Window Cleaning Booking Request\n\nPreferred Date: ${formData.date}\nPreferred Time: ${formData.time}\n\nMessage: ${formData.message}`,
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <motion.div variants={elementVariants}>
                                <div className="border-l-4 border-blue-500 pl-4 mb-6">
                                    <span className="text-blue-600 font-semibold">Window Cleaning</span>
                                </div>
                                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                                    Window Cleaning Services
                                </h1>
                                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                    Transform your view with our professional window cleaning service. We deliver streak-free, crystal-clear results for both residential and commercial properties using advanced techniques and eco-friendly solutions.
                                </p>
                                <p className="text-gray-600 leading-relaxed">
                                    Our experienced team handles everything from single-story homes to multi-story commercial buildings, ensuring spotless windows inside and out with maximum safety and efficiency.
                                </p>
                            </motion.div>
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">Streak-Free Window Cleaning</h2>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Our window cleaning service ensures crystal-clear results that enhance your property’s appearance and allow maximum natural light. We use eco-friendly solutions and professional-grade equipment for exceptional outcomes.
                            </p>
                            <p className="text-gray-600 leading-relaxed">
                                From residential homes to high-rise commercial buildings, our trained team delivers safe and efficient cleaning, leaving your windows spotless and your views unobstructed.
                            </p>
                        </div>
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Window Cleaning Services</h2>
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="space-y-6">
                            {[
                                { name: 'Cleaning Effectiveness', percentage: 93 },
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="space-y-8">
                            {[
                                { step: 1, title: 'Window Assessment', description: 'Initial inspection to determine cleaning needs' },
                                { step: 2, title: 'Safe Cleaning', description: 'Using professional tools and eco-friendly solutions' },
                                { step: 3, title: 'Polishing', description: 'Ensuring streak-free, crystal-clear results' },
                                { step: 4, title: 'Final Inspection', description: 'Guaranteeing spotless windows' }
                            ].map((item, index) => (
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="relative rounded-xl overflow-hidden">
                            <iframe
                                width="100%"
                                height="315"
                                src="https://www.youtube.com/embed/weq4Zb7bueM?si=Ryz3a-GVUI2HCQW9"
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">Clear Your View Today</h2>
