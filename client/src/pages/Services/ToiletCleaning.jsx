...
// Import images
import office1 from '../../assets/images/toilet1.jpg';
import office2 from '../../assets/images/toilet2.jpg';
import office3 from '../../assets/images/toilet3.jpg';
import office4 from '../../assets/images/toilet4.jpg';
import office5 from '../../assets/images/toilet5.jpg';
import office7 from '../../assets/images/toilet1.jpg';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(import.meta.env.VITE_CONTACT_URL || 'http://localhost:4000/api/contact', {
                ...
                message: `Toilet Cleaning Booking Request\n\nPreferred Date: ${formData.date}\nPreferred Time: ${formData.time}\n\nMessage: ${formData.message}`,
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <motion.div variants={elementVariants}>
                                <div className="border-l-4 border-blue-500 pl-4 mb-6">
                                    <span className="text-blue-600 font-semibold">Toilet Cleaning</span>
                                </div>
                                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                                    Toilet Cleaning Services
                                </h1>
                                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                    Our comprehensive toilet cleaning service ensures complete hygiene and sanitation for your restrooms. We use eco-friendly, hospital-grade disinfectants to eliminate germs, bacteria, and odors, leaving your facilities spotless and fresh.
                                </p>
                                <p className="text-gray-600 leading-relaxed">
                                    From residential bathrooms to commercial restrooms, our trained professionals follow strict protocols to deliver thorough cleaning and disinfection of all surfaces and fixtures.
                                </p>
                            </motion.div>
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">Hygienic Toilet Cleaning</h2>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Our toilet cleaning service ensures your restrooms are spotless and sanitized, promoting health and hygiene. We use hospital-grade disinfectants to eliminate germs and odors effectively.
                            </p>
                            <p className="text-gray-600 leading-relaxed">
                                Our team is trained to handle both residential and commercial restrooms, delivering thorough cleaning and disinfection to maintain the highest standards of cleanliness.
                            </p>
                        </div>
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Toilet Cleaning Services</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                'Deep Toilet Bowl Cleaning & Disinfection',
                                'Sink & Faucet Sanitization',
                                'Floor Mopping & Disinfection',
                                'Mirror & Surface Cleaning',
                                'Toilet Paper & Supply Restocking',
                                'Odor Elimination & Air Freshening'
                            ].map((service, index) => (
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="space-y-6">
                            {[
                                { name: 'Cleaning Effectiveness', percentage: 94 },
                                { name: 'Customer Satisfaction', percentage: 91 },
                                { name: 'Hygiene Compliance', percentage: 96 }
                            ].map((item, index) => (
                                <div key={index}>
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="space-y-8">
                            {[
                                { step: 1, title: 'Restroom Assessment', description: 'Initial inspection to identify cleaning needs' },
                                { step: 2, title: 'Deep Cleaning', description: 'Thorough cleaning of all fixtures and surfaces' },
                                { step: 3, title: 'Sanitization', description: 'Applying hospital-grade disinfectants for hygiene' },
                                { step: 4, title: 'Final Inspection', description: 'Ensuring a spotless and fresh restroom' }
                            ].map((item, index) => (
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="relative rounded-xl overflow-hidden">
                            <iframe
                                width="100%"
                                height="315"
                                src="https://www.youtube.com/embed/3CFoZl0T3GQ?si=5WWfvk_SHEIJZOCW"
                ...
                >
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">Keep Your Restrooms Spotless Today</h2>
